    ...
    coupon: {
      ...
      select: {
        ...
        friend_coupon: {
          ...
          caption:
            'в джс не було капшону на дизайні був, це для перевірки',
        },
      },
      add: {
        friend: {
